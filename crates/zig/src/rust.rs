...
//         self.src.push_str("comptime {\n");

//         let world = &resolve.worlds[world];
//         for (world_key, _) in world.exports.iter() {
//             match world_key {
//                 WorldKey::Name(name) => {
//                     self.src.push_str(&format!(
...
//                     ));
//                 }
//                 WorldKey::Interface(_) => todo!(),
//             }
//         }
//         self.src.push_str("}\n\n");
//         self.src.push_str("pub fn main() void {}");
...
//         files.push(&format!("{module_name}.zig"), src.as_bytes());
//     }
// }
